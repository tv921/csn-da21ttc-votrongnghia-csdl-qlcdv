...
<head>
    ...
    <link rel="stylesheet" href="giao_dien_web/bootstrap-5.3.2-dist/css/bootstrap.min.css">
</head>
<body>
  <style>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="sign.php">
    ...
    <div class="collapse navbar-collapse navbar-grand" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link navbar-brand" href="sign.php">Trang chủ</a>
        </li> 
      </ul>
      <span class="nav-re">
